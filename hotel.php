...
<head>
	...
	<title>RSM Tours - Hotel information</title>
	...
	?>	
				...
				<section class="three-fourth">
					...
					<section class="gallery" id="crossfade">
						<img src="admin/<?php echo $result['image1'];?>" alt="" width="850" height="531" />
						<img src="admin/<?php echo $result['image2'];?>" alt="" width="850" height="531" />	
						<img src="admin/<?php echo $result['image3'];?>" alt="" width="850" height="531" />
						<img src="admin/<?php echo $result['image4'];?>" alt="" width="850" height="531" />
					</section>
					<!--//gallery-->
...
function myFunction() {
    ...
    document.getElementById("grandvtotal_<?php echo $rresult['id'];?>").innerHTML = vTotal;
				...
				<h1><br>
					<div>Total Price(Without VAT):  BDT <span id="grandtotal_<?php echo $rresult['id'];?>">0.00</span></div>
				</h1>
				<h1>
					<div>Total Price(With VAT):     BDT <span id="grandvtotal_<?php echo $rresult['id'];?>">0.00</span></div>
				</h1>
					...
					<p>Prices are per room<br />15 % VAT Included in price</p>
					<p>Non-refundable<br />Full breakfast $ 24.80 </p>
		...
		<?php }  }else{ echo "No review found.";} ?>
				...
				<aside class="right-sidebar">
					...
					<article class="hotel-details clearfix">
						<h1><?php echo $_SESSION['hotelname']= $result['title']; ?>
							<span class="stars">
